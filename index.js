...
function takeCommand(message) {
    ...
    if (message.includes("hello") || message.includes("hello Harsh") || message.includes("hello robo harsh")) {
        speak("Hello sir, how can I help you?");
    } 
    else if (message.includes("who are you") || message.includes("hu r u")) {
        speak("I am a virtual assistant, created by Harsh sir.");
    }
    ...
    else if(message.includes("time"))
    {
        ...
        {
            speak("prateek is Harsh friend");
        }
        else if(message.includes("Harsh") || message.includes("Harshnath"))
            {
                speak("Harsh is my creator");
            }
            else if(message.includes("akash") || message.includes("aakash"))
                {
                    speak("akash Harsh ka bhai hai aur uske papa ka naam sarvesh choudhary hai aur mummy ka naam rani choudhary hai");
                }
                    ...
                    speak("My name is Robo Harsh, your personal assistant created by Harsh sir.");
                }
                    ...
                    speak("I was created by Harsh sir, a talented computer science engineer.");
                }
                    ...
                    speak("I'm from the virtual world, created by Harsh sir.");
                }
                    ...
                    speak("I don't have personal preferences, but I hear that Sir Harsh is quite amazing!");
                }
    ...
    // else{
    //     let finalText="this is what i found on internet sir"+message.replace("Harsh","")||message.replace("robo Harsh","");
    //     speak(finalText);
    //     window.open(`https://www.google.com/search?q=${message.replace("Harsh","")}`,"_blank");
    // }
    else {
